...
class MainActivity : AppCompatActivity() {
    ...
    private fun addNewPerson() {
        ...
        if(manageUserType() == findViewById<RadioButton>(R.id.student_group).id) {
            ...
            val person = Student(name, firstName,birthday, nationality, university, graduationYear,
            email, remark)
            people.add(person)
    ...
    private fun getNationality() : String {
         ...
         */
        private fun manageUserType() : Int {
            var id: Int = -1
